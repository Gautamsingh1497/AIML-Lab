...
print("15. Cross product of two arrays:")
print(np.cross(array3, array4))

# SciPy library functions
print("\nSciPy Library:")
data = [1, 2, 2, 3, 3, 3, 4, 4, 4, 4]
print("1. Mode of a dataset:", stats.mode(data, keepdims=True))
print("2. Normal probability density function for mean 0 and standard deviation 1:")
print(stats.norm.pdf(0, loc=0, scale=1))
print("3. Chi-squared probability density function for degrees of freedom 2:")
print(stats.chi2.pdf(2, df=2))
...
print("6. Poisson probability mass function for lambda 2 and k 3:")
print(stats.poisson.pmf(3, mu=2))
print("7. Exponential cumulative distribution function for scale 1:")
print(stats.expon.cdf(1, scale=1))
